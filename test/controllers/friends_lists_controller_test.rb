...
class FriendsListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friends_list" do
    assert_difference("FriendsList.count") do
      post friends_lists_url, params: { friends_list: { contact: @friends_list.contact, first_name: @friends_list.first_name, last_name: @friends_list.last_name, twitter: @friends_list.twitter } }
    end
  ...
  test "should update friends_list" do
    patch friends_list_url(@friends_list), params: { friends_list: { contact: @friends_list.contact, first_name: @friends_list.first_name, last_name: @friends_list.last_name, twitter: @friends_list.twitter } }
